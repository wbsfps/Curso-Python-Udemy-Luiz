...
path =  "./projeto/secao4/os_remove_os_unlink_e_os_rename_apagando_renomeando_e_movendo_arquivos.txt"
...
# os.unlink(path)
# os.remove(path)
os.rename(path, "./projeto/secao4/os_remove_os_unlink_e_os_rename.txt")